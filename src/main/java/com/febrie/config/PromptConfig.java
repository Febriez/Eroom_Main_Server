...
public class PromptConfig {
    ...
    private String gameManagerSystemPrompt;
    private String individualObjectSystemPrompt;
    ...
    private void loadConfig() {
        try {
            ...
            try (InputStreamReader reader = new InputStreamReader(input, StandardCharsets.UTF_8)) {
                ...
                gameManagerSystemPrompt = config.getAsJsonObject("prompts").get("gameManager").getAsString();
                individualObjectSystemPrompt = config.getAsJsonObject("prompts").get("individualObject").getAsString();
    ...
    private void loadDefaultSettings() {
        ...
        gameManagerSystemPrompt = "null";
        individualObjectSystemPrompt = "null";
    }
