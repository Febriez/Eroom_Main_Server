...
public class HttpServer {
    ...
    public HttpServer(int port) {
        ...
        // Meshy API 엔드포인트 추가
        routes.add(Methods.POST, "/api/meshy/create-preview", new MeshyPreviewHandler());
        routes.add(Methods.POST, "/api/meshy/create-refine", new MeshyRefineHandler());
        routes.add(Methods.POST, "/api/meshy/create-full-model", new MeshyFullModelHandler());
        routes.add(Methods.GET, "/api/meshy/task-status", new MeshyTaskStatusHandler());
        routes.add(Methods.GET, "/api/meshy/check-interrupted", new MeshyCheckInterruptedHandler());
